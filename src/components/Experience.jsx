  ...
  return (
    ...
    >
      <div className="flex-shrink-0">
        <div className="w-16 h-16 md:w-20 md:h-20 bg-[#87CEEB]/10 rounded-lg flex items-center justify-center overflow-hidden border-2 border-[#87CEEB]/30 hover:border-[#87CEEB]/60 transition-colors duration-300">
          <img
            src={data.logo}
        ...
        {data.skills.length > 0 && (
          <div className="flex flex-wrap gap-1.5 md:gap-2">
            {data.skills.map((skill, index) => (
              <span
                key={index}
                className="px-2 md:px-3 py-0.5 md:py-1 bg-[#87CEEB]/10 text-[#87CEEB] rounded-full text-xs"
              >
                {skill}
              </span>
            ))}
